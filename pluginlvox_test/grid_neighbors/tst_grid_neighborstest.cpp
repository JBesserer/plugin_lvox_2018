...
void Grid_neighborsTest::testDistanceInterpolation_data()
{
	 ...
	 */
    QTest::newRow("trivial1") << 1.1 << 0 << eps1 << 0.5f << 0.5f << 0.5f << size_t(0) << size_t(0) << size_t(0);
    QTest::newRow("trivial2") << 1.1 << 2 << eps1 << 0.5f << 0.5f << 0.5f << size_t(0) << size_t(0) << size_t(0);
    QTest::newRow("trivial3") << 1.8 << 2 << eps1 << 0.5f << 0.5f << 0.5f << size_t(0) << size_t(0) << size_t(0);
    ...
    QTest::newRow("diag1") << 1.8 << 2 << eps1 << num1/den1 << a << b << size_t(5) << size_t(4) << size_t(4);
    QTest::newRow("diag2") << 1.8 << 2 << eps1 << num2/den1 << a << b << size_t(5) << size_t(5) << size_t(4);
    QTest::newRow("diag3") << 1.8 << 2 << eps1 << num3/den1 << a << b << size_t(5) << size_t(5) << size_t(5);
    ...
    QTest::newRow("consider zeros") << 1.8 << 2 << eps2 << num4/den1 << zero << b << size_t(5) << size_t(4) << size_t(4);
    QTest::newRow("ignore zeros")   << 1.8 << 2 << eps1 << num4/den2 << zero << b << size_t(5) << size_t(4) << size_t(4);
}
