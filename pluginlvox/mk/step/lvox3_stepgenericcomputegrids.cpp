...
QString LVOX3_StepGenericComputeGrids::getStepDetailledDescription() const
{
    return tr("Cette étape permet de créer une grille 3D de densité à partir des trois grilles de l'étape précédente (Hits, Theoritical, Before). En plus, cette étape donne une valeur d'erreur à des voxels ayant trop d'occlusion.");
}
