...
private:
    ...
    CT_AutoRenameModels m_outGrid3DModelName;

    CT_AutoRenameModels _ProfileFlag_ModelName;
     ...
     */
    void addProfile(CT_Profile<double>* profile, CT_ResultGroup* outResult, CT_StandardItemGroup* group, lvox::Grid3Df* grid);
