...
QString LVOX3_StepComputeSky::getStepDetailledDescription() const
{
    return tr("Cette étape permet de créer une grille 3D à partir d'une taille de voxel défini et également de créer un raster pour le ciel.");
}
