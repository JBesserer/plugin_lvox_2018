...
namespace lvox {
     ...
     */
    struct LVOXSHAREDFORTEST_EXPORT InGridConfiguration {
        char            gridLetter;
     ...
     */
    struct LVOXSHAREDFORTEST_EXPORT CheckConfiguration {
     ...
     */
    struct LVOXSHAREDFORTEST_EXPORT OutGridConfiguration {
     ...
     */
    struct LVOXSHAREDFORTEST_EXPORT PredefinedConfiguration {
